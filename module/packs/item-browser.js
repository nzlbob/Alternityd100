...
export class ItemBrowserSFRPG extends Application {
  static get defaultOptions() {
    ...
    options.template = 'systems/Alternityd100/templates/packs/item-browser.html';
...
//console.log(der | Compendium Browser | ${pack.metadata.label} - ${content.length} entries found`);
