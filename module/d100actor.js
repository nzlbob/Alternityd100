 ...
 * @extends {Actor}
 */
 export class d100Actor extends Mix(foundry.documents.Actor).with(ActorConditionsMixin, ActorCrewMixin, ActorInventoryMixin, ActorModifiersMixin, ActorResourcesMixin, ActorRestMixin) {
...
if (this.type=="starship"){
  ...
  console.log(d100A.skills,skillId,skl)
  skl.name = name
  //skl.stepdie = 2
