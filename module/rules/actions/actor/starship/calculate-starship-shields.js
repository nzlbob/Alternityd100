...
/*
        ...
        if (!data.hasShields) {
            ...
            if (data.hasDeflectorShields) {
                data.quadrants.forward.shields.max = shieldData.defenceValue;
                data.quadrants.port.shields.max = shieldData.defenceValue;
                data.quadrants.starboard.shields.max = shieldData.defenceValue;
                data.quadrants.aft.shields.max = shieldData.defenceValue;
            } else {
