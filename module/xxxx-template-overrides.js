...
export default function() {
    ...
    TemplateLayer.prototype._onDragLeftStart = function (event) {
        if (!game.settings.get("Alternityd100", "useStarfinderAOETemplates")) return _templateLayerOriginalOnDragLeftStart.call(this, event);
        //if (false) return _templateLayerOriginalOnDragLeftStart.call(this, event);
    ...
    TemplateLayer.prototype._onDragLeftMove = function (event) {
        if (!game.settings.get("Alternityd100", "useStarfinderAOETemplates")) return _templateLayerOriginalOnDragLeftMove.call(this, event);
       // if (false) return _templateLayerOriginalOnDragLeftMove.call(this, event);
        PlaceablesLayer.prototype._onDragLeftMove.call(this, event);
        if (event.data.createState >= 1) {
            // Snap the destination to the grid
            let dest = event.interactionData.destination;
            ...
            let ray = new Ray(event.interactionData.origin, event.interactionData.destination);
    ...
    MeasuredTemplate.prototype.highlightGrid = function () {
        if (!game.settings.get("Alternityd100", "useStarfinderAOETemplates") || !["circle", "cone"].includes(this.data.t)) return _measuredTemplateOriginalHightlightGrid.call(this);
        //if (true || !["circle", "cone"].includes(this.data.t)) return _measuredTemplateOriginalHightlightGrid.call(this);
